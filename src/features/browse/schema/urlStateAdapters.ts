...
const schemaToReduxKeyMap: Record<string, string> = {
  ...
  rarities: 'rarities',
  sets: 'sets',
  formatsLegal: 'formatsLegal',
  formatsLegalIncludeBanned: 'formatsLegalIncludeBanned',
  stats: 'stats',
  cardsSortBy: 'sortBy',
  cardsSortOrder: 'sortOrder',
  setsSortBy: 'sortBy',
  setsSortOrder: 'sortOrder',
...
const reduxToSchemaKeyMap: Record<string, string | [string, string]> = {
  ...
  formatsLegalIncludeBanned: 'formatsLegalIncludeBanned',
  stats: 'stats',
  sortBy: ['cardsSortBy', 'setsSortBy'],
  sortOrder: ['cardsSortOrder', 'setsSortOrder'],
...
export function convertStateToUrlParams(
  ...
  Object.entries(state).forEach(([reduxKey, value]) => {
    ...
    // Skip pagination parameters as they're now stored in localStorage
...
function addNumberParameter(params: URLSearchParams, value: number, config: ParameterConfig, key: string) {
  ...
  if (value !== undefined && value !== null) {
    // Skip pagination params (cardsPageSize, setsPageSize) as they're now in localStorage
